    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-full px-3 py-1.5 shadow-sm hover:shadow-md hover:scale-105 transition-all duration-250 cursor-pointer group">
                        ...
                        <div className="w-8 h-8 rounded-full bg-gray-900 flex items-center justify-center hover:scale-110 active:scale-95 transition-transform cursor-pointer shadow-md">
            ...
            <div className="flex items-center justify-between mb-6">
                <h1 className="text-2xl font-semibold text-gray-400">New Report</h1>
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-800 font-medium">Timeframe</span>
                    </div>
                    <button className="flex items-center gap-2 px-6 py-2.5 text-sm text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-full transition-all active:scale-95">
