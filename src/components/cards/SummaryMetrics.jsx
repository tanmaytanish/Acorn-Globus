    ...
    return (
        <div className="flex items-start gap-6 mb-8 mt-4">
            ...
            <div className="flex items-center gap-3 ml-auto">
                {/* Top Sales */}
                <div className="bg-white rounded-2xl p-3 border border-gray-100 shadow-sm min-w-[140px] hover:shadow-md hover:scale-[1.02] transition-all duration-250 group cursor-pointer">
                ...
                {/* Best Deal - Dark Card */}
                <div className="bg-gray-900 rounded-2xl p-3 shadow-md min-w-[140px] hover:shadow-lg hover:scale-[1.02] hover:bg-gray-800 transition-all duration-250 group cursor-pointer">
                ...
                {/* Deals */}
                <div className="bg-white rounded-2xl p-3 border border-gray-100 shadow-sm min-w-[80px] hover:shadow-md hover:scale-[1.02] transition-all duration-250 cursor-pointer group">
                ...
                {/* Value */}
                <div className="bg-white rounded-2xl p-3 border border-pink-500/50 shadow-sm min-w-[80px] hover:shadow-md hover:scale-[1.02] hover:border-pink-500 transition-all duration-250 cursor-pointer group">
